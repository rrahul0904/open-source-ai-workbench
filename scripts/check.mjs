...
const required = ['package.json','server.mjs','public/index.html','public/app.js','public/styles.css','api/health.js','api/capabilities.js','api/runs.js','api/workflows/run.js','vercel.json','Dockerfile','.github/workflows/ci.yml'];
